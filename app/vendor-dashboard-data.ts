...
export const products: VendorProduct[] = [
  {
    ...
    brand: "Sheglam",
    categoryLevels: ["Beauty", "Hair Care", "Hair Appliances", "Curling Irons"],
    sellingPrice: 49000,
    costPrice: 45085,
    commissionPct: 8,
    ...
    colors: [
      {
        ...
        nameAr: "Silver",
        nameEn: "Silver",
        sizes: [{ size: "Standard", quantity: 12 }],
      },
    ],
    imageTone: "#d7dce6",
  ...
  },
  {
    ...
    keywords: ["dryer", "hair", "salon", "dryer"],
    materialCode: "MAT-EM-DRY-2000",
    sku: "em-dry-90-bk",
    barcode: "8901234567892",
    vendorCode: "EM-DRY-2000",
    brand: "Electromall",
    categoryLevels: ["Beauty", "Hair Care", "Hair Appliances", "Hair Dryers"],
    sellingPrice: 65000,
    costPrice: 56000,
    commissionPct: 10,
    ...
    colors: [
      {
        ...
        nameAr: "Black",
        nameEn: "Black",
        sizes: [{ size: "Standard", quantity: 0 }],
      },
    ],
    imageTone: "#222831",
  ...
  },
  {
    ...
    keywords: ["braun", "trimmer", "grooming", "trimmer"],
    materialCode: "MAT-BR-TRIM-09",
    sku: "br-trim-09-rd",
    barcode: "8901234567893",
    vendorCode: "BR-TR-09-R",
    brand: "Braun",
    categoryLevels: ["Electronics", "Personal Care", "Shaving", "Trimming Machines"],
    sellingPrice: 21000,
    costPrice: 18000,
    commissionPct: 8,
    ...
    colors: [
      {
        ...
        nameAr: "Red",
        nameEn: "Red",
        sizes: [{ size: "Standard", quantity: 5 }],
      },
    ],
    imageTone: "#d94b4b",
  ...
  },
  {
    ...
    brand: "Oraimo",
    categoryLevels: ["Electronics", "Audio", "Earbuds", "Wireless"],
    sellingPrice: 38000,
    costPrice: 32000,
    commissionPct: 9,
    discountPlanStatus: "none",
    ...
    colors: [
      {
        ...
        nameAr: "White",
        nameEn: "White",
        sizes: [{ size: "Standard", quantity: 24 }],
      },
    ],
    imageTone: "#eef2f6",
